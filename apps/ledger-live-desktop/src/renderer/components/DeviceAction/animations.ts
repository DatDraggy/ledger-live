...
// // @ts-ignore
// import STAX_DARK_PIN from "~/renderer/animations/flex/dark/pin.json";
// // @ts-ignore
// import STAX_LIGHT_PIN from "~/renderer/animations/flex/light/pin.json";
// // @ts-ignore
// import STAX_DARK_CONTINUE from "~/renderer/animations/flex/dark/continue.json";
// // @ts-ignore
// import STAX_LIGHT_CONTINUE from "~/renderer/animations/flex/light/continue.json";
// // @ts-ignore
// import STAX_DARK_PAIRED from "~/renderer/animations/flex/dark/paired.json";
// // @ts-ignore
// import STAX_LIGHT_PAIRED from "~/renderer/animations/flex/light/paired.json";
// // @ts-ignore
// import STAX_DARK_PAIRING from "~/renderer/animations/flex/dark/pairing.json";
// // @ts-ignore
// import STAX_LIGHT_PAIRING from "~/renderer/animations/flex/light/pairing.json";

// // @ts-ignore
// import STAX_DARK_PIN from "~/renderer/animations/nanoX/dark/pin.json";
// // @ts-ignore
// import STAX_LIGHT_PIN from "~/renderer/animations/nanoX/light/pin.json";
// // @ts-ignore
// import STAX_DARK_CONTINUE from "~/renderer/animations/nanoX/dark/continue.json";
// // @ts-ignore
// import STAX_LIGHT_CONTINUE from "~/renderer/animations/nanoX/light/continue.json";
// @ts-ignore
